...
sys.path.insert(0, "bertglove/bert-master/")
copytree('bertglove/keras_bert','/kaggle/working')
...
#load train data
train_df = pd.read_csv('bertglove/train.csv')
train_df = train_df.sample(frac=0.16,random_state = 42)
#load test data
test_df = pd.read_csv('bertglove/test.csv')
#text lines
...
submission = pd.read_csv('bertglove/test.csv', index_col='id')
